...
--
-- Name: territories_territoryid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.territories_territoryid_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.territories_territoryid_seq OWNER TO postgres;

--
-- Name: territories_territoryid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.territories_territoryid_seq OWNED BY public.territories.territoryid;
...
--
-- Name: territories territoryid; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.territories ALTER COLUMN territoryid SET DEFAULT nextval('public.territories_territoryid_seq'::regclass);
...
--
-- Name: territories_territoryid_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.territories_territoryid_seq', 1, false);
...
ALTER TABLE ONLY public.employees
    ADD CONSTRAINT employees_reportsto_fkey FOREIGN KEY (reportsto) REFERENCES public.employees(employeeid);
